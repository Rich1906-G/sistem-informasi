...
<head>
    ...
    <title>Login — Logbook Admin</title>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="flex items-center gap-3 mb-5 text-white drop-shadow">
                    ...
                    <div>
                        ...
                        <h1 class="text-4xl font-bold leading-tight">Admin</h1>
                    </div>
                </div>
                ...
                <div
                    ...
                    <form class="grid gap-4" action="{{ route('login.admin.submit') }}" method="post" novalidate>
                        @csrf
                ...
                {{-- Footer kecil --}}
                <p class="mt-3 text-xs text-center text-white/70">© {{ date('Y') }} — Sistem Logbook Admin.</p>
            </div>
        </div>
    </div>
</body>
