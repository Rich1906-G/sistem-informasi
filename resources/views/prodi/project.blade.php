<x-layout-prodi>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md sm:rounded-lg relative md:mx-4 lg:mx-4 xl:my-8 xl:mx-4"
        ...
        <div class="flex flex-col items-center p-4 md:flex-row md:space-y-0 lg:justify-between">
            ...
            <button type="button" @click="openModalCreateProject = true; dataTugas = @js($data_tugas)"
                    ...
                    @foreach ($data_project as $project)
                        @foreach ($project->mahasiswa as $mahasiswa)
                            <tr class="xl:text-base">
                                <td class="px-4 py-3 lg:py-4">{{ $data_project->firstItem() + $loop->index }}</td>
                                <td class="px-4 py-3 lg:py-4">{{ $mahasiswa->nama_mahasiswa }}</td>
                                <td class="px-4 py-3 lg:py-4">{{ $project->tugas->nama_tugas }}</td>
                                <td class="px-4 py-3 lg:py-4">{{ $project->nama_project }}</td>
                                <td class="px-4 py-3 lg:py-4">{{ $project->nama_file_project }}</td>
                                <td class="px-4 py-3 lg:py-4">{{ $project->file_project }}</td>
                                <td class="px-4 py-3 lg:py-4">{{ $project->status }}</td>
                            </tr>
                        @endforeach
                    @endforeach
                </tbody>
        ...
        <div x-show="openModalCreateProject" x-cloak
            class="fixed inset-0 bg-black/50 flex items-center justify-center">
            <div class="bg-white rounded-lg p-6 w-1/2">
                <h2 class="text-xl font-semibold mb-4">Tambah Project</h2>

                <form action="{{ route('prodi.tambah.project.mahasiswa') }}" method="POST"
                    ...
                    <!-- Nama Project -->
                    <div class="mb-4">
                        <label for="nama_project" class="block font-medium">Nama Project</label>
                    ...
                    <!-- Upload File -->
                    {{-- <div class="mb-4">
                        <label for="file_project" class="block font-medium">File Project</label>
                        <input type="file" name="file_project" id="file_project"
                            class="w-full border rounded p-2">
                    </div> --}}

                    <div class="flex justify-end gap-4">
                        <button @click="openModalCreateProject = false"
