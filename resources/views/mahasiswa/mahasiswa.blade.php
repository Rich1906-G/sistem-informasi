            ...
            <table class="w-full md:w-full md:text-sm text-center  text-gray-500 dark:text-gray-400 ">
                ...
                <tbody>
                    <tr class="xl:text-base">
                        <td class="px-4 py-3 lg:py-4">{{ $data_mahasiswa->nama_mahasiswa }}</td>
                        <td class="px-4 py-3 lg:py-4">{{ $data_mahasiswa->nim }}</td>
                        <td class="px-4 py-3 lg:py-4">{{ $data_mahasiswa->semester }}</td>
                        <td class="px-4 py-3 lg:py-4">{{ $data_mahasiswa->no_hp }}</td>
                        <td class="px-4 py-3 lg:py-4 flex items-center justify-center">
                            <img src="{{ asset($data_mahasiswa->pas_foto) }}"
                        ...
                        <td class="px-4 py-3 lg:py-4 w-auto">
                            ...
                            <button type="button"
                                @click="hapus1Data = ! hapus1Data ; noHapus='{{ $data_mahasiswa->contr_id }}';"
